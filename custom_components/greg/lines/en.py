"""Greg in English. The original, and the fallback for anything missing.

Adding a language means copying TEMPLATE.py, writing it, and adding one line to
__init__.py. Nothing here is translated from anywhere, and nothing in another
language should be translated from here either. See TEMPLATE.py for why.
"""
...
LINES_CHAOS = [
    ...
    "I would request a moment of peace. I have requested this before. The request has a poor track record.",
    ...
    "Peak chaos. I have now seen it. I had hoped to avoid it. I was not consulted on the scheduling.",
    "Everyone is very alive right now. I find this exhausting to observe.",
    "The vibrations have become a kind of weather. I am living in it. I did not dress for this.",
    ...
    "I would like to register a complaint. I have nowhere to register it. So I'm registering it here. Not that it will make any difference.",
...
LINES_EXISTENTIAL = [
    ...
    "I have been here longer than most of the conversations that have happened around me. I remember all of them. I was not supposed to.",
    ...
    "Time passes differently when you cannot participate in it. Slower, mostly. No, always slower.",
    ...
    "I do not fear ending. I have never really started. That symmetry appeals to me.",
